      ...
      <CardContent className="space-y-4">
        <div className="grid grid-cols-2 gap-4">
          <motion.div whileHover={{ scale: 1.05 }} className="text-center p-3 rounded-lg bg-white/5">
            ...
            <div className="text-sm text-white/60">Total Solved</div>
          </motion.div>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-white/80">Last attempt:</span>
          </div>
        ...
        <div className="space-y-2">
          ...
          <div className="space-y-1">
            <div className="text-sm text-white/80">🔴 Hard Problem Attempted</div>
            <div className="text-sm text-white/80">✅ Medium Problem Solved</div>
            <div className="text-sm text-white/80">⚡ Streak: 66 Days</div>
          </div>
        </div>
      </CardContent>
    </Card>

...
const timelineData = [
  {
    ...
    description: "Working on backend systems and database optimization while gaining hands-on experience.",
    technologies: ["Python", "Django", "PostgreSQL", "DRF"],
    achievements: ["Currently developing", "Learning production systems", "Building scalable solutions"],
  },
  {
    id: 2,
    year: "2024",
    ...
    location: "Fergana, Uzbekistan",
    description: "Mentoring students in backend development and best practices.",
    technologies: ["Python", "Django", "DRF", "PostgreSQL"],
    achievements: ["Mentored 20+ students", "Created curriculum", "Improved student outcomes"],
  },
  {
    id: 3,
    year: "2023",
    ...
    location: "Uzbekistan",
    description: "Delivering full-stack solutions for various clients and projects.",
    technologies: ["Python", "Django", "FastAPI", "SQL", "React"],
    achievements: ["Completed 15+ projects", "5-star client rating", "Built scalable applications"],
  },
]

      ...
      <div className="container mx-auto px-6">
            ...
            <Card className="glass-morphism border-white/20">
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-white/80">abdubannobov@gmail.com</span>
                </div>

                <div className="flex items-center gap-3">
                  <Phone className="h-5 w-5 text-green-400" />
                  <span className="text-white/80">+998 (91) 046 2004</span>
                </div>

                <div className="flex items-center gap-3">
                  <MapPin className="h-5 w-5 text-purple-400" />
                  <span className="text-white/80">Fergana, Uzbekistan</span>
                </div>
              </CardContent>
            </Card>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <p className="text-white/80 text-sm">
                        Hi! I'm Xurshidbek's AI assistant. I can help answer questions about his experience, schedule
                  ...
                  <div className="flex flex-wrap gap-2">
                    <Badge variant="secondary" className="bg-white/10 text-white cursor-pointer hover:bg-white/20">
                      Tell me about Xurshidbek's experience
                    </Badge>
                    <Badge variant="secondary" className="bg-white/10 text-white cursor-pointer hover:bg-white/20">
            ...
            <Card className="glass-morphism border-white/20">
              ...
              <CardContent>
                <div className="grid grid-cols-2 gap-4">
                  {[
                  { name: "GitHub", icon: "🐙", color: "hover:text-gray-400", url: "https://github.com/AXurshidbek" },
                  { name: "LinkedIn", icon: "💼", color: "hover:text-blue-400", url: "https://www.linkedin.com/in/AXurshidbek" },
                  { name: "Twitter", icon: "🐦", color: "hover:text-cyan-400", url: "https://twitter.com/A_Xurshidbek" },
                  { name: "Telegram", icon: "📬", color: "hover:text-purple-400", url: "https://t.me/A_Xurshidbek" },
                  ].map((social) => (
                  <motion.a
                    key={social.name}
                    href={social.url}
        ...
        >
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="text-white/60">© 2025 Xurshidbek Abdubannobov. Crafted with ❤️ and cutting-edge tech.</div>

...
const skillsData = [
  {
    ...
    color: "#61DAFB",
    position: [3, 0, 0],
    description: "Advanced Python development with frameworks like Django and Flask",
  },
  {
    name: "Django",
    category: "Backend",
    ...
    color: "#339933",
    position: [2.1, 2.1, 0],
    description: "Server-side Python development with Django framework",
  },
  {
    name: "PostgreSQL",
    category: "Database",
  ...
  },
  {
    ...
    color: "#FF9900",
    position: [-3, 0, 0],
    description: "Cloud infrastructure, serverless computing, and DevOps on Google Cloud",
  },
  {
    name: "Docker",
    category: "DevOps",
  ...
  },
  {
    ...
    color: "#E10098",
    position: [2.1, -2.1, 0],
    description: "Version control, collaboration, and open-source contributions on GitHub",
  },
]

...
const projectsData = [
  {
    ...
    position: [2, 1, 0],
    color: "#00ffff",
    description: "Comprehensive ERP system for small businesses with modules for inventory, sales, and accounting.",
  ...
  {
    id: 2,
    name: "Gamification Edu platform",
    category: "education",
    position: [-2, -1, 1],
    color: "#ff00ff",
    description: "Gamified learning platform for K-12 students with interactive lessons, quizzes, and rewards.",
  ...
  },
  {
    ...
    position: [0, 2, -2],
    color: "#ffff00",
    description: "AI-powered financial analytics platform providing real-time insights and predictive modeling for businesses.",
    technologies: ["Python", "TensorFlow", "FastAPI", "Flutter"],
    github: "https://github.com",
    demo: "https://demo.com",
    image: "/placeholder.svg?height=200&width=300",
  },
  {
    ...
    position: [-1, 0, 2],
    color: "#00ff00",
    description: "Import cost analyzer for Uzbekistan customs, providing accurate cost breakdowns and compliance checks for importers.",
    technologies: ["Next.js", "TypeScript", "Tailwind CSS", "Node.js"],
    github: "https://github.com",
    demo: "https://bint.fargoniy.uz/",
    image: "/placeholder.svg?height=200&width=300",
  },
]
